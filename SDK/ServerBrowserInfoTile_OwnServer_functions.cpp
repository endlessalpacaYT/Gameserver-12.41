...
{
	static auto Func = Class->GetFunction("ServerBrowserInfoTile_OwnServer_C", "OnLoaded_48F9B2C944196B333B43868DC1DE5716");
...
{
	static auto Func = Class->GetFunction("ServerBrowserInfoTile_OwnServer_C", "SetBackgroundImage");
