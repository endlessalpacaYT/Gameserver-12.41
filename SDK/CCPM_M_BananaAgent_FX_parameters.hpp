...
struct ACCPM_M_BananaAgent_FX_C_OnPawnAndPartChanged_Params
{
public:
};
...
struct ACCPM_M_BananaAgent_FX_C_OnActualStatChange_Params
{
public:
};
...
struct ACCPM_M_BananaAgent_FX_C_HackyWorkaroundRefreshTimerGuy_Params
{
public:
};
...
struct ACCPM_M_BananaAgent_FX_C_ResetSafetyGate_Params
{
public:
};
...
struct ACCPM_M_BananaAgent_FX_C_OnPostResIn_Params
{
public:
};
...
struct ACCPM_M_BananaAgent_FX_C_InitializeVariabels_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_5A03[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
