...
{
	static auto Func = Class->GetFunction("BP_Frontend_EventLevel_NavObject_BattlePassInfo_C", "SetBattlePassVisuals");
...
{
	static auto Func = Class->GetFunction("BP_Frontend_EventLevel_NavObject_BattlePassInfo_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("BP_Frontend_EventLevel_NavObject_BattlePassInfo_C", "OnLoaded_5B4B515147509217750E62A2CDE15CEF");
...
{
	static auto Func = Class->GetFunction("BP_Frontend_EventLevel_NavObject_BattlePassInfo_C", "ReceiveBeginPlay");

	Params::ABP_Frontend_EventLevel_NavObject_BattlePassInfo_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Frontend_EventLevel_NavObject_BattlePassInfo_C", "InitForBattlePassInfo");
...
{
	static auto Func = Class->GetFunction("BP_Frontend_EventLevel_NavObject_BattlePassInfo_C", "OnUpdateWidgetVisibility");
...
{
	static auto Func = Class->GetFunction("BP_Frontend_EventLevel_NavObject_BattlePassInfo_C", "UpdateVisuals");

	Params::ABP_Frontend_EventLevel_NavObject_BattlePassInfo_C_UpdateVisuals_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Frontend_EventLevel_NavObject_BattlePassInfo_C", "OnInitializeForPlayer");

	Params::ABP_Frontend_EventLevel_NavObject_BattlePassInfo_C_OnInitializeForPlayer_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Frontend_EventLevel_NavObject_BattlePassInfo_C", "ExecuteUbergraph_BP_Frontend_EventLevel_NavObject_BattlePassInfo");
