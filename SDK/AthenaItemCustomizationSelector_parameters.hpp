...
public:
	...
	uint8                                        Pad_95D[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetLockerItemTypeText_ReturnValue;        // 0x40(0x18)()
	class FText                                  CallFunc_GetLockerDescriptionText_ReturnValue;     // 0x58(0x18)()
	...
	class FText                                  K2Node_CustomEvent_NewText;                        // 0x1D8(0x18)()
