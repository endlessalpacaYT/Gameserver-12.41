...
public:
	...
	uint8                                        Pad_5607[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayTagContainer                 CallFunc_MakeGameplayTagContainerFromArray_ReturnValue; // 0x80(0x20)()
	...
	struct FGameplayTagContainer                 CallFunc_MakeGameplayTagContainerFromArray_ReturnValue_1; // 0x158(0x20)()
...
struct AB_HidingProp_C_FadeToBlackTimeLine__FinishedFunc_Params
{
public:
};
...
struct AB_HidingProp_C_FadeToBlackTimeLine__UpdateFunc_Params
{
public:
};
...
public:
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x118(0xB0)()
	...
	struct FGameplayTagContainer                 CallFunc_MakeGameplayTagContainerFromArray_ReturnValue; // 0x230(0x20)()
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData_1;             // 0x300(0xB0)()
	...
	uint8                                        Pad_561D[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext;                        // 0x510(0x18)()
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData_2;             // 0x528(0xB0)()
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData_3;             // 0x660(0xB0)()
	...
	struct FGameplayTagContainer                 CallFunc_MakeGameplayTagContainerFromArray_ReturnValue_1; // 0x7E0(0x20)()
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData_4;             // 0x800(0xB0)()
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData_5;             // 0x8C8(0xB0)()
	...
	struct FGameplayTagContainer                 CallFunc_GetAthenaPlaylistContextTags_ReturnValue; // 0xC28(0x20)()
	...
	struct FGameplayTagContainer                 Temp_struct_Variable;                              // 0xC68(0x20)()
	...
	struct FGameplayTagContainer                 CallFunc_MakeGameplayTagContainerFromArray_ReturnValue_2; // 0xD28(0x20)()
