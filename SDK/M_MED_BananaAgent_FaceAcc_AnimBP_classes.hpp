...
public:
	...
	struct FAnimNode_Constraint                  AnimGraphNode_Constraint_1;                        // 0x458(0x108)()
	struct FAnimNode_Constraint                  AnimGraphNode_Constraint;                          // 0x560(0x108)()
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;               // 0x668(0x20)()
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;               // 0x688(0x20)()
	...
	struct FAnimNode_LayeredBoneBlend            AnimGraphNode_LayeredBoneBlend;                    // 0x928(0xC0)()
	struct FAnimNode_SaveCachedPose              AnimGraphNode_SaveCachedPose;                      // 0x9E8(0xB8)()
	struct FAnimNode_UseCachedPose               AnimGraphNode_UseCachedPose;                       // 0xAA0(0x28)()
	uint8                                        Pad_6754[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAnimNode_RigidBody                   AnimGraphNode_RigidBody_1;                         // 0xAD0(0x5A0)()
	struct FAnimNode_RigidBody                   AnimGraphNode_RigidBody;                           // 0x1070(0x5A0)()
	...
	{
		static class UClass* Clss = UObject::FindClassFast("M_MED_BananaAgent_FaceAcc_AnimBP_C");
		return Clss;
	}
