...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "ApplyLevelParam");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "ApplyOverrideToItems");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "GetAssociatedAthenaController");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "Death Check");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "OnStatChanged_69B250E44334E860958973A8995D6FC6");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "OnPawnAndPartChanged");

	Params::ACCPM_F_TNTina_FX_C_OnPawnAndPartChanged_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "OnActualStatChange");

	Params::ACCPM_F_TNTina_FX_C_OnActualStatChange_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "HackyWorkaroundRefreshTimerGuy");

	Params::ACCPM_F_TNTina_FX_C_HackyWorkaroundRefreshTimerGuy_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "ResetSafetyGate");

	Params::ACCPM_F_TNTina_FX_C_ResetSafetyGate_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "OnPostResIn");

	Params::ACCPM_F_TNTina_FX_C_OnPostResIn_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "InitializeVariabels");

	Params::ACCPM_F_TNTina_FX_C_InitializeVariabels_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_FX_C", "ExecuteUbergraph_CCPM_F_TNTina_FX");
