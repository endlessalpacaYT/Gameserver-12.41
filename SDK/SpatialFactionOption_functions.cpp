...
{
	static auto Func = Class->GetFunction("SpatialFactionOption_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("SpatialFactionOption_C", "BP_OnUnhovered");

	Params::USpatialFactionOption_C_BP_OnUnhovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialFactionOption_C", "BP_OnHovered");

	Params::USpatialFactionOption_C_BP_OnHovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialFactionOption_C", "ExecuteUbergraph_SpatialFactionOption");
