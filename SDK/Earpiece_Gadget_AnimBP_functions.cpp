...
{
	static auto Func = Class->GetFunction("Earpiece_Gadget_AnimBP_C", "AnimGraph");
...
{
	static auto Func = Class->GetFunction("Earpiece_Gadget_AnimBP_C", "ExecuteUbergraph_Earpiece_Gadget_AnimBP");
