...
{
	static auto Func = Class->GetFunction("LeaderboardTab_C", "Colorize");
...
{
	static auto Func = Class->GetFunction("LeaderboardTab_C", "Set Event");
...
{
	static auto Func = Class->GetFunction("LeaderboardTab_C", "ExecuteUbergraph_LeaderboardTab");
