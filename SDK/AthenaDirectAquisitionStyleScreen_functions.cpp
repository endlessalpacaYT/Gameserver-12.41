...
{
	static auto Func = Class->GetFunction("AthenaDirectAquisitionStyleScreen_C", "BndEvt__CloseButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
