...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "CanCommitNavigationRequest");
...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "OnFailure_AB29FEEF4A9F4CD168E2D5879757C696");

	Params::ABP_Donut_Discoverable_C_OnFailure_AB29FEEF4A9F4CD168E2D5879757C696_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "OnIgnored_AB29FEEF4A9F4CD168E2D5879757C696");

	Params::ABP_Donut_Discoverable_C_OnIgnored_AB29FEEF4A9F4CD168E2D5879757C696_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "OnSuccess_AB29FEEF4A9F4CD168E2D5879757C696");

	Params::ABP_Donut_Discoverable_C_OnSuccess_AB29FEEF4A9F4CD168E2D5879757C696_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "OnComplete_AEFB9D694F5A3C235235769245C02722");
...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "HandleObjectSpecialInteraction");
...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "ResetCooldown");

	Params::ABP_Donut_Discoverable_C_ResetCooldown_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "NotifiedByDiscoverable");
...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "Commit_OnSpecialInteraction");

	Params::ABP_Donut_Discoverable_C_Commit_OnSpecialInteraction_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "ReceiveBeginPlay");

	Params::ABP_Donut_Discoverable_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Donut_Discoverable_C", "ExecuteUbergraph_BP_Donut_Discoverable");
