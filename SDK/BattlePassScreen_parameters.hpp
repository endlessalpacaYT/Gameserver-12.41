...
public:
	...
	struct FVideoConfig_Mono                     K2Node_MakeStruct_VideoConfig_Mono;                // 0x20(0x60)()
...
public:
	...
	uint8                                        Pad_6ED1[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6ED2[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct UBattlePassScreen_C_Construct_Params
{
public:
};
...
struct UBattlePassScreen_C_Destruct_Params
{
public:
};
...
struct UBattlePassScreen_C_OnSetDifferentBPText_Params
{
public:
};
...
public:
	...
	struct FFortRarityItemData                   K2Node_Event_Rarity;                               // 0x68(0x80)()
	...
	uint8                                        Pad_6EEB[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6EEC[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
