...
{
	static auto Func = Class->GetFunction("BP12_MIdas_Mannequin_C", "OnPartChanged");
...
{
	static auto Func = Class->GetFunction("BP12_MIdas_Mannequin_C", "OnVariantChanged");
...
{
	static auto Func = Class->GetFunction("BP12_MIdas_Mannequin_C", "ExecuteUbergraph_BP12_MIdas_Mannequin");
