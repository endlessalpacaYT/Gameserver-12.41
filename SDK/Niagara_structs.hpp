...
enum class ENiagaraFastPathInputType : uint8
{
	Local                          = 0,
	RangedSpawn                    = 1,
	RangedUpdate                   = 2,
...
enum class ENiagaraFastPathMode : uint8
{
	ScriptVMOnly                   = 0,
	FastPathOnly                   = 1,
...
public:
	...
	uint8                                        Pad_EDE[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        BitPad_C0 : 5;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F49[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F53[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F6B[0x78];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_FAC[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
