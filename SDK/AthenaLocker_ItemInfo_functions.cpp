...
{
	static auto Func = Class->GetFunction("AthenaLocker_ItemInfo_C", "Overide Item Info");
...
{
	static auto Func = Class->GetFunction("AthenaLocker_ItemInfo_C", "Set item definition");
...
{
	static auto Func = Class->GetFunction("AthenaLocker_ItemInfo_C", "Set item definition Invalid");

	Params::UAthenaLocker_ItemInfo_C_Set_item_definition_Invalid_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaLocker_ItemInfo_C", "ExecuteUbergraph_AthenaLocker_ItemInfo");
