...
public:
	...
	uint8                                        Pad_61CF[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateColor                           K2Node_MakeStruct_SlateColor_1;                    // 0x120(0x28)()
...
struct USpatialCustomizationSelection_C_BP_OnActivated_Params
{
public:
};
...
struct USpatialCustomizationSelection_C_Construct_Params
{
public:
};
...
struct USpatialCustomizationSelection_C_Play_Intro_Animation__Params
{
public:
};
