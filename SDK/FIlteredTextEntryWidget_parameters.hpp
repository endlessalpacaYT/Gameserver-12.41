...
public:
	...
	uint8                                        Pad_6C1D[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class FText                                  CallFunc_GetErrorText_Appropriate_Text;            // 0x8(0x18)()
	...
	uint8                                        Pad_6C21[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetCurrentText_Text;                      // 0x160(0x18)()
...
struct UFilteredTextEntryWidget_C_OnTextCommitByEnter__DelegateSignature_Params
{
public:
};
