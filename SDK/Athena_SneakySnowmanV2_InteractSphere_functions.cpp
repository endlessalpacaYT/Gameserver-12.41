...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "GetFocusedSocketLocation");
...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "Init");
...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "OnRep_AssociatedSnowman");

	Params::AAthena_SneakySnowmanV2_InteractSphere_C_OnRep_AssociatedSnowman_Params Parms;
...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "BlueprintGetInteractionTime");
...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "BlueprintGetInteractionString");
...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "BlueprintCanInteract");
...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "Destroy");
...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "BlueprintOnInteract");
...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "BlueprintOnBeginInteract");

	Params::AAthena_SneakySnowmanV2_InteractSphere_C_BlueprintOnBeginInteract_Params Parms;
...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "BlueprintOnInterruptInteract");

	Params::AAthena_SneakySnowmanV2_InteractSphere_C_BlueprintOnInterruptInteract_Params Parms;
...
{
	static auto Func = Class->GetFunction("Athena_SneakySnowmanV2_InteractSphere_C", "ExecuteUbergraph_Athena_SneakySnowmanV2_InteractSphere");
