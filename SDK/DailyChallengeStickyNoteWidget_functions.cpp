...
{
	static auto Func = Class->GetFunction("DailyChallengeStickyNoteWidget_C", "HandleHasChallengeUpdated");
...
{
	static auto Func = Class->GetFunction("DailyChallengeStickyNoteWidget_C", "OnReplaceConfirmationClosed");
...
{
	static auto Func = Class->GetFunction("DailyChallengeStickyNoteWidget_C", "OnHasChallengeUpdated");
...
{
	static auto Func = Class->GetFunction("DailyChallengeStickyNoteWidget_C", "ExecuteUbergraph_DailyChallengeStickyNoteWidget");
