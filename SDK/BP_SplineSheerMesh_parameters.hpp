...
struct ABP_SplineSheerMesh_C_UserConstructionScript_Params
{
public:
	...
	bool                                         CallFunc_SetStaticMesh_ReturnValue;                // 0x49(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
