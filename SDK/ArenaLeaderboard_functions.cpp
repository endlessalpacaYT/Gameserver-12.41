...
{
	static auto Func = Class->GetFunction("ArenaLeaderboard_C", "Initialize Children For Event");
...
{
	static auto Func = Class->GetFunction("ArenaLeaderboard_C", "OnLeaderboardEntrySelected");
...
{
	static auto Func = Class->GetFunction("ArenaLeaderboard_C", "OnInitialized");

	Params::UArenaLeaderboard_C_OnInitialized_Params Parms;
...
{
	static auto Func = Class->GetFunction("ArenaLeaderboard_C", "ShowMyStats");
...
{
	static auto Func = Class->GetFunction("ArenaLeaderboard_C", "SetupForEvent");
...
{
	static auto Func = Class->GetFunction("ArenaLeaderboard_C", "OnColorize");
...
{
	static auto Func = Class->GetFunction("ArenaLeaderboard_C", "BP_OnDeactivated");

	Params::UArenaLeaderboard_C_BP_OnDeactivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("ArenaLeaderboard_C", "Item Double-Clicked");

	Params::UArenaLeaderboard_C_Item_Double_Clicked_Params Parms;
...
{
	static auto Func = Class->GetFunction("ArenaLeaderboard_C", "Construct");

	Params::UArenaLeaderboard_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("ArenaLeaderboard_C", "ExecuteUbergraph_ArenaLeaderboard");
