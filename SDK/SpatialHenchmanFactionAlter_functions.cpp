...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlter_C", "OnFocusReceived");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlter_C", "InitForVariant");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlter_C", "Construct");

	Params::USpatialHenchmanFactionAlter_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlter_C", "OnMouseEnter");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlter_C", "OnMouseLeave");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlter_C", "BndEvt__SpatialHenchmenViewMoreButton_K2Node_ComponentBoundEvent_2_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlter_C", "OnFocusLost");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlter_C", "ExecuteUbergraph_SpatialHenchmanFactionAlter");
