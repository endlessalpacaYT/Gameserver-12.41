...
{
	static auto Func = Class->GetFunction("B_Prj_Bullet_Sniper_Heavy_C", "OnTouched");
...
{
	static auto Func = Class->GetFunction("B_Prj_Bullet_Sniper_Heavy_C", "OnSniperTraceWaterHit");
...
{
	static auto Func = Class->GetFunction("B_Prj_Bullet_Sniper_Heavy_C", "ExecuteUbergraph_B_Prj_Bullet_Sniper_Heavy");
