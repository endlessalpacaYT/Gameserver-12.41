...
{
	static auto Func = Class->GetFunction("SpatialFaction_ShadowButton_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("SpatialFaction_ShadowButton_C", "BP_OnHovered");

	Params::USpatialFaction_ShadowButton_C_BP_OnHovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialFaction_ShadowButton_C", "BP_OnUnhovered");

	Params::USpatialFaction_ShadowButton_C_BP_OnUnhovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialFaction_ShadowButton_C", "On Selected");

	Params::USpatialFaction_ShadowButton_C_On_Selected_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialFaction_ShadowButton_C", "On Unselected");

	Params::USpatialFaction_ShadowButton_C_On_Unselected_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialFaction_ShadowButton_C", "ExecuteUbergraph_SpatialFaction_ShadowButton");
