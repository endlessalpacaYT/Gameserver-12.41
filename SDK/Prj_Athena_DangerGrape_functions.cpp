...
{
	static auto Func = Class->GetFunction("Prj_Athena_DangerGrape_C", "ReceiveBeginPlay");

	Params::APrj_Athena_DangerGrape_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("Prj_Athena_DangerGrape_C", "BndEvt__WaterInteractionComponent_K2Node_ComponentBoundEvent_0_WaterInteractionOnEnterWater__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("Prj_Athena_DangerGrape_C", "OnStop");
...
{
	static auto Func = Class->GetFunction("Prj_Athena_DangerGrape_C", "ReceiveHit");
...
{
	static auto Func = Class->GetFunction("Prj_Athena_DangerGrape_C", "ExecuteUbergraph_Prj_Athena_DangerGrape");
