...
public:
	...
	struct FIndicatedActorData                   CallFunc_MakeIndicatedActorData_ReturnValue;       // 0x90(0x80)()
	...
	struct FStenciledActorData                   CallFunc_MakeStenciledActorData_ReturnValue;       // 0x118(0x70)()
	...
	struct FIndicatedActorData                   CallFunc_MakeIndicatedActorData_ReturnValue_1;     // 0x1A0(0x80)()
	struct FIndicatedActorDataWithFilter         CallFunc_MakeIndicatedActorDataWithFilter_ReturnValue; // 0x220(0x130)()
	...
	struct FIndicatedActorData                   CallFunc_MakeIndicatedActorData_ReturnValue_2;     // 0x388(0x80)()
	...
	struct FIndicatedActorData                   CallFunc_MakeIndicatedActorData_ReturnValue_3;     // 0x410(0x80)()
	...
	uint8                                        Pad_5781[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FStenciledActorData                   CallFunc_MakeStenciledActorData_ReturnValue_1;     // 0x508(0x70)()
	struct FIndicatedActorDataWithFilter         CallFunc_MakeIndicatedActorDataWithFilter_ReturnValue_1; // 0x578(0x130)()
	...
	struct FStenciledActorData                   CallFunc_MakeStenciledActorData_ReturnValue_2;     // 0x6C8(0x70)()
	...
	struct FIndicatedActorDataWithFilter         CallFunc_MakeIndicatedActorDataWithFilter_ReturnValue_2; // 0x740(0x130)()
	...
	struct FStenciledActorData                   CallFunc_MakeStenciledActorData_ReturnValue_3;     // 0x8A0(0x70)()
	...
	struct FGameplayEffectContextHandle          CallFunc_MakeFortEffectContext_ReturnValue;        // 0x928(0x18)()
	...
	uint8                                        Pad_578B[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable_3;                            // 0x1D0(0x28)()
	...
	uint8                                        Pad_579A[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
