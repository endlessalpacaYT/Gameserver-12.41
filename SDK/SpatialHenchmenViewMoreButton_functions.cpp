...
{
	static auto Func = Class->GetFunction("SpatialHenchmenViewMoreButton_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenViewMoreButton_C", "Construct");

	Params::USpatialHenchmenViewMoreButton_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenViewMoreButton_C", "SetMissionStateVisuals");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenViewMoreButton_C", "OnMouseLeave");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenViewMoreButton_C", "OnMouseEnter");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenViewMoreButton_C", "OnRemovedFromFocusPath");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenViewMoreButton_C", "OnAddedToFocusPath");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenViewMoreButton_C", "ExecuteUbergraph_SpatialHenchmenViewMoreButton");
