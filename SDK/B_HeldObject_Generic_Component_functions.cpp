...
{
	static auto Func = Class->GetFunction("B_HeldObject_Generic_Component_C", "K2_OnUnEquip");

	Params::AB_HeldObject_Generic_Component_C_K2_OnUnEquip_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_HeldObject_Generic_Component_C", "OnWeaponAttached");

	Params::AB_HeldObject_Generic_Component_C_OnWeaponAttached_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_HeldObject_Generic_Component_C", "ExecuteUbergraph_B_HeldObject_Generic_Component");
