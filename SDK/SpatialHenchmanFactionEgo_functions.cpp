...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionEgo_C", "OnFocusReceived");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionEgo_C", "InitForVariant");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionEgo_C", "BndEvt__SpatialHenchmenViewMoreButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionEgo_C", "OnMouseLeave");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionEgo_C", "OnMouseEnter");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionEgo_C", "Construct");

	Params::USpatialHenchmanFactionEgo_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionEgo_C", "ExecuteUbergraph_SpatialHenchmanFactionEgo");
