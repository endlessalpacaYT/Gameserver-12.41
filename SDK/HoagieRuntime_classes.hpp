...
public:
	...
	uint8                                        Pad_16C[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_170[0xE];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C6[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C8[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1D4[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1D6[0x1B];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1E0[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
