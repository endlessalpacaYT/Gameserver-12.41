...
{
	static auto Func = Class->GetFunction("AthenaChallengePageRotator_C", "BP_OnOptionsPopulated");
...
{
	static auto Func = Class->GetFunction("AthenaChallengePageRotator_C", "BP_OnOptionSelected");
...
{
	static auto Func = Class->GetFunction("AthenaChallengePageRotator_C", "OnNumPagesSet");
...
{
	static auto Func = Class->GetFunction("AthenaChallengePageRotator_C", "SetVisibility-PostAnim");

	Params::UAthenaChallengePageRotator_C_SetVisibility_PostAnim_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaChallengePageRotator_C", "SetInputBindingVisiblity");
...
{
	static auto Func = Class->GetFunction("AthenaChallengePageRotator_C", "ExecuteUbergraph_AthenaChallengePageRotator");
