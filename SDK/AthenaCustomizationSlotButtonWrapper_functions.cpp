...
{
	static auto Func = Class->GetFunction("AthenaCustomizationSlotButtonWrapper_C", "ResetPopulateAnimVisual");
...
{
	static auto Func = Class->GetFunction("AthenaCustomizationSlotButtonWrapper_C", "SetCardImage");
...
{
	static auto Func = Class->GetFunction("AthenaCustomizationSlotButtonWrapper_C", "AnimPopulateInternal");
