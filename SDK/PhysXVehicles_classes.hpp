...
public:
	...
	uint8                                        Pad_71A[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_722[0x24];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_72D[0x700];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_72E[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_73C[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
