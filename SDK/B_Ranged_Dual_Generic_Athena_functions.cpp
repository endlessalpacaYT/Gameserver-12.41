...
{
	static auto Func = Class->GetFunction("B_Ranged_Dual_Generic_Athena_C", "ShellEjectionFixOn");

	Params::AB_Ranged_Dual_Generic_Athena_C_ShellEjectionFixOn_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Dual_Generic_Athena_C", "Bind on Effects Quality");

	Params::AB_Ranged_Dual_Generic_Athena_C_Bind_on_Effects_Quality_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Dual_Generic_Athena_C", "ShellEjectionOff");

	Params::AB_Ranged_Dual_Generic_Athena_C_ShellEjectionOff_Params Parms;
