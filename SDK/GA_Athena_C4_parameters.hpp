...
public:
	...
	uint8                                        Pad_651D[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x1C8(0xB0)()
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x278(0x28)()
