...
{
	static auto Func = Class->GetFunction("FakeStatsGraphs_C", "RandomizeTiling");
...
{
	static auto Func = Class->GetFunction("FakeStatsGraphs_C", "RandomizeTimings");
...
{
	static auto Func = Class->GetFunction("FakeStatsGraphs_C", "RandomizePositions");
...
{
	static auto Func = Class->GetFunction("FakeStatsGraphs_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("FakeStatsGraphs_C", "Construct");

	Params::UFakeStatsGraphs_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("FakeStatsGraphs_C", "ExecuteUbergraph_FakeStatsGraphs");
