...
struct UGA_Athena_Apply_SneakySnowmanV2_C_K2_ActivateAbility_Params
{
public:
};
...
struct UGA_Athena_Apply_SneakySnowmanV2_C_OnFInishedJumpingIn_Params
{
public:
};
...
struct UGA_Athena_Apply_SneakySnowmanV2_C_HolsterWeapon__Params
{
public:
};
...
struct UGA_Athena_Apply_SneakySnowmanV2_C_UnholsterWeapon__Params
{
public:
};
...
struct UGA_Athena_Apply_SneakySnowmanV2_C_UpdateHolster_Params
{
public:
};
...
struct UGA_Athena_Apply_SneakySnowmanV2_C_SetMatInt_Params
{
public:
};
...
public:
	...
	struct FGameplayEventData                    K2Node_CustomEvent_Payload_1;                      // 0xC8(0xB0)()
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate_3;            // 0x178(0x10)(ZeroConstructor, NoDestructor)
	struct FGameplayEventData                    Temp_struct_Variable_2;                            // 0x188(0xB0)()
	...
	struct FGameplayEffectContextHandle          CallFunc_GetGrantedByEffectContext_ReturnValue;    // 0x640(0x18)()
	struct FGameplayEffectContextHandle          CallFunc_GetGrantedByEffectContext_ReturnValue_1;  // 0x658(0x18)()
	...
	struct FGameplayEffectContextHandle          CallFunc_GetGrantedByEffectContext_ReturnValue_2;  // 0x6F0(0x18)()
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x7E8(0x28)()
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable_4;                            // 0x820(0x28)()
	...
	struct FGameplayEffectContextHandle          CallFunc_GetGrantedByEffectContext_ReturnValue_3;  // 0xA38(0x18)()
