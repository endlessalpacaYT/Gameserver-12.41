...
{
	static auto Func = Class->GetFunction("SpatialCategorySelectButton_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("SpatialCategorySelectButton_C", "Construct");

	Params::USpatialCategorySelectButton_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialCategorySelectButton_C", "InputSourceChanged");
...
{
	static auto Func = Class->GetFunction("SpatialCategorySelectButton_C", "BP_OnHovered");

	Params::USpatialCategorySelectButton_C_BP_OnHovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialCategorySelectButton_C", "BP_OnUnhovered");

	Params::USpatialCategorySelectButton_C_BP_OnUnhovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialCategorySelectButton_C", "ExecuteUbergraph_SpatialCategorySelectButton");
