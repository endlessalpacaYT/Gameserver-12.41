...
public:
	...
	uint8                                        Pad_D46[0x2B];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D4B[0x45];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DB2[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DB8[0xA0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DC8[0xA8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E0A[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("NiagaraShaderStageBase");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("NiagaraShaderStagePlaceholderA");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("NiagaraShaderStagePlaceholderB");
		return Clss;
	}
...
public:
	...
	uint8                                        Pad_EC7[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_ED0[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
