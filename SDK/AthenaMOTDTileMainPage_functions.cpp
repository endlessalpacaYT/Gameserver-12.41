...
{
	static auto Func = Class->GetFunction("AthenaMOTDTileMainPage_C", "BP_OnSelected");

	Params::UAthenaMOTDTileMainPage_C_BP_OnSelected_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaMOTDTileMainPage_C", "BP_OnDeselected");

	Params::UAthenaMOTDTileMainPage_C_BP_OnDeselected_Params Parms;
