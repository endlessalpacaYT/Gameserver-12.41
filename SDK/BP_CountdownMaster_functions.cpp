...
{
	static auto Func = Class->GetFunction("BP_CountdownMaster_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("BP_CountdownMaster_C", "ExecuteUbergraph_BP_CountdownMaster");
