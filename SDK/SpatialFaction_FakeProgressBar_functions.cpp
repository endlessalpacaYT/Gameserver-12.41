...
{
	static auto Func = Class->GetFunction("SpatialFaction_FakeProgressBar_C", "Increment");
...
{
	static auto Func = Class->GetFunction("SpatialFaction_FakeProgressBar_C", "set random percentage");
...
{
	static auto Func = Class->GetFunction("SpatialFaction_FakeProgressBar_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("SpatialFaction_FakeProgressBar_C", "stop bar anim");

	Params::USpatialFaction_FakeProgressBar_C_Stop_bar_anim_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialFaction_FakeProgressBar_C", "play bar anim");

	Params::USpatialFaction_FakeProgressBar_C_Play_bar_anim_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialFaction_FakeProgressBar_C", "ExecuteUbergraph_SpatialFaction_FakeProgressBar");
