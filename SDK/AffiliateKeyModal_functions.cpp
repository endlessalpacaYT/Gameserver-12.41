...
{
	static auto Func = Class->GetFunction("AffiliateKeyModal_C", "BndEvt__CloseButton_Mobile_K2Node_ComponentBoundEvent_2_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("AffiliateKeyModal_C", "WidgetAnimationEvt_SuccessAnim_K2Node_WidgetAnimationEvent_1");

	Params::UAffiliateKeyModal_C_WidgetAnimationEvt_SuccessAnim_K2Node_WidgetAnimationEvent_1_Params Parms;
