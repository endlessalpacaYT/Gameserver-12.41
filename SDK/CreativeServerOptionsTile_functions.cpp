...
{
	static auto Func = Class->GetFunction("CreativeServerOptionsTile_C", "OnLoaded_3534B041413498BC4DD6D2B727558DF9");
...
{
	static auto Func = Class->GetFunction("CreativeServerOptionsTile_C", "SetBackgroundImage");
