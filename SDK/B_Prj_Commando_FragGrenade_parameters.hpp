...
public:
	...
	uint8                                        Pad_53FE[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5407[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5408[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromLocations_ReturnValue; // 0x470(0x28)()
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x498(0xB0)()
};
