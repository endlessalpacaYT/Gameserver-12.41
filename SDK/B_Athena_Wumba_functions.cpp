...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "UpdateAnimInstanceVisuals");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "SetUiVisibility");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "LocalOnFailedInteract");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "BlueprintGetInteractionTime");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "SetLightColor");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "BlueprintGetFailedInteractionString");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "GetOverrideRarity");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "SetRarityColors");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "BlueprintGetInteractionString");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "Timeline_1__FinishedFunc");

	Params::AB_Athena_Wumba_C_Timeline_1__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "Timeline_1__UpdateFunc");

	Params::AB_Athena_Wumba_C_Timeline_1__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "OnReady_524B43EB45254EC3646C7D81A1AA3359");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "PlayVendFailFX");

	Params::AB_Athena_Wumba_C_PlayVendFailFX_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "OnDeathPlayEffects");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "PlayUpgradeSuccess");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "BlueprintOnBeginInteract");

	Params::AB_Athena_Wumba_C_BlueprintOnBeginInteract_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "OnDamagePlayEffects");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "BlueprintOnInteract");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "WobbleMachine");

	Params::AB_Athena_Wumba_C_WobbleMachine_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "ReceiveBeginPlay");

	Params::AB_Athena_Wumba_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "BlueprintOnInteractInterrupted");

	Params::AB_Athena_Wumba_C_BlueprintOnInteractInterrupted_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "ReceiveDestroyed");

	Params::AB_Athena_Wumba_C_ReceiveDestroyed_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "CheckShouldDisplayUI");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "InitializeUI");

	Params::AB_Athena_Wumba_C_InitializeUI_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "BndEvt__SphereDetail_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "BndEvt__SphereDetail_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "BndEvt__CylinderDistance_K2Node_ComponentBoundEvent_4_ComponentBeginOverlapSignature__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "BndEvt__CylinderDistance_K2Node_ComponentBoundEvent_5_ComponentEndOverlapSignature__DelegateSignature");
...
// struct FGameplayTagContainer       K2Node_Select_Default_2                                          ()
...
{
	static auto Func = Class->GetFunction("B_Athena_Wumba_C", "ExecuteUbergraph_B_Athena_Wumba");
