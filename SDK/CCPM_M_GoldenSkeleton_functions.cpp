...
{
	static auto Func = Class->GetFunction("CCPM_M_GoldenSkeleton_C", "Death Check");
...
{
	static auto Func = Class->GetFunction("CCPM_M_GoldenSkeleton_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("CCPM_M_GoldenSkeleton_C", "OnStatChanged_A4D4C55946C69552A0D4EFBD92EA9526");
...
{
	static auto Func = Class->GetFunction("CCPM_M_GoldenSkeleton_C", "OnPawnAndPartChanged");

	Params::ACCPM_M_GoldenSkeleton_C_OnPawnAndPartChanged_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_GoldenSkeleton_C", "OnActualStatChange");

	Params::ACCPM_M_GoldenSkeleton_C_OnActualStatChange_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_GoldenSkeleton_C", "HackyWorkaroundRefreshTimerGuy");

	Params::ACCPM_M_GoldenSkeleton_C_HackyWorkaroundRefreshTimerGuy_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_GoldenSkeleton_C", "ResetSafetyGate");

	Params::ACCPM_M_GoldenSkeleton_C_ResetSafetyGate_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_GoldenSkeleton_C", "OnPostResIn");

	Params::ACCPM_M_GoldenSkeleton_C_OnPostResIn_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_GoldenSkeleton_C", "InitializeVariabels");

	Params::ACCPM_M_GoldenSkeleton_C_InitializeVariabels_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_GoldenSkeleton_C", "ExecuteUbergraph_CCPM_M_GoldenSkeleton");
