...
{
	static auto Func = Class->GetFunction("HardcoreModifierListEntry_C", "OnMouseEnter");
...
{
	static auto Func = Class->GetFunction("HardcoreModifierListEntry_C", "OnMouseLeave");
...
{
	static auto Func = Class->GetFunction("HardcoreModifierListEntry_C", "Construct");

	Params::UHardcoreModifierListEntry_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("HardcoreModifierListEntry_C", "HandleModifierEnabled");
...
{
	static auto Func = Class->GetFunction("HardcoreModifierListEntry_C", "SetMaxLevelCompleted");
...
{
	static auto Func = Class->GetFunction("HardcoreModifierListEntry_C", "ExecuteUbergraph_HardcoreModifierListEntry");
