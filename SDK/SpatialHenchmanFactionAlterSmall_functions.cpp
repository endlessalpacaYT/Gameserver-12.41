...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlterSmall_C", "Construct");

	Params::USpatialHenchmanFactionAlterSmall_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlterSmall_C", "OnMouseEnter");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlterSmall_C", "OnMouseLeave");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlterSmall_C", "BndEvt__SpatialHenchmenViewMoreButton_K2Node_ComponentBoundEvent_2_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlterSmall_C", "OnFocusLost");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmanFactionAlterSmall_C", "ExecuteUbergraph_SpatialHenchmanFactionAlterSmall");
