...
{
	static auto Func = Class->GetFunction("BP_ProjectileTrajectory_HeldObjectSocket_C", "ReceiveBeginPlay");

	Params::ABP_ProjectileTrajectory_HeldObjectSocket_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_ProjectileTrajectory_HeldObjectSocket_C", "ExecuteUbergraph_BP_ProjectileTrajectory_HeldObjectSocket");

	Params::ABP_ProjectileTrajectory_HeldObjectSocket_C_ExecuteUbergraph_BP_ProjectileTrajectory_HeldObjectSocket_Params Parms;
