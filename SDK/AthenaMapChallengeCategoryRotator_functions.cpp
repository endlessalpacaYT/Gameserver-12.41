...
{
	static auto Func = Class->GetFunction("AthenaMapChallengeCategoryRotator_C", "PlayIntroAnim");
...
{
	static auto Func = Class->GetFunction("AthenaMapChallengeCategoryRotator_C", "BP_OnOptionsPopulated");
...
{
	static auto Func = Class->GetFunction("AthenaMapChallengeCategoryRotator_C", "BP_OnOptionSelected");
...
{
	static auto Func = Class->GetFunction("AthenaMapChallengeCategoryRotator_C", "Construct");

	Params::UAthenaMapChallengeCategoryRotator_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaMapChallengeCategoryRotator_C", "HandleOnInputMethodChanged");
...
{
	static auto Func = Class->GetFunction("AthenaMapChallengeCategoryRotator_C", "Destruct");

	Params::UAthenaMapChallengeCategoryRotator_C_Destruct_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaMapChallengeCategoryRotator_C", "ExecuteUbergraph_AthenaMapChallengeCategoryRotator");
