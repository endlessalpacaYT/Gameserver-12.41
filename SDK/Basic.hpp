...
static __int64 (*FreeMemory)(void*) = decltype(FreeMemory)(__int64(GetModuleHandleW(0)) + 0x2B31FA0);
static void* (*FMemory_Realloc)(void* Memory, int64 NewSize, uint32 Alignment) = decltype(FMemory_Realloc)(__int64(GetModuleHandleW(0)) + 0x2B409C0);
...
public:
	...
	inline void Add(T& New)
	{
		Data = (T*)FMemory_Realloc(Data, (MaxElements = NumElements + 1) * sizeof(T), 0);
...
public:
	...
	uint8                                        Pad_71D2[0x4];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_71D3[0x8];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	int32                                        ElementSize;                                       // (0x3C[0x04]) NOT AUTO-GENERATED PROPERTY
	uint64                                       PropertyFlags;                                     // (0x40[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_71D4[0x4];                                     // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_71D5[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_71D6[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_71D7[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_71D8[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_71D9[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_71DA[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_71DB[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_71DC[0x28];                                    // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
