...
struct AB_Prj_Athena_SneakySnowmanV2_C_Explode_Params
{
public:
};
...
struct AB_Prj_Athena_SneakySnowmanV2_C_ReceiveBeginPlay_Params
{
public:
};
...
struct AB_Prj_Athena_SneakySnowmanV2_C_Apply_Snowman_To_Self_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_5AD0[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayTagContainer                 CallFunc_MakeGameplayTagContainerFromArray_ReturnValue; // 0x158(0x20)()
	...
	uint8                                        Pad_5AE1[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x370(0xB0)()
