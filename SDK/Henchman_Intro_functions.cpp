...
{
	static auto Func = Class->GetFunction("SequenceDirector_C", "BP_Battlepass_LightSwitcher_Hench_Event_1");
...
{
	static auto Func = Class->GetFunction("SequenceDirector_C", "BP_Battlepass_LightSwitcher_Hench_Event_2");
