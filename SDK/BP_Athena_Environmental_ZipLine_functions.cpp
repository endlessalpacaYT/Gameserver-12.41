...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_C", "BlueprintCanInteract");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_C", "CalculatePositionsOfPoles");
