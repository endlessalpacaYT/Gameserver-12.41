...
public:
	...
	struct FGameplayTagContainer                 CallFunc_GetOwnedGameplayTags_TagContainer;        // 0x88(0x20)()
	...
	uint8                                        Pad_4DBE[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext;                        // 0x2D8(0x18)()
	...
	struct FFortItemEntry                        CallFunc_Array_Get_Item;                           // 0x308(0x150)()
	...
	uint8                                        Pad_4DCB[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext_1;                      // 0x540(0x18)()
