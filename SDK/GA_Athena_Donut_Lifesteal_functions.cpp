...
{
	static auto Func = Class->GetFunction("GA_Athena_Donut_Lifesteal_C", "K2_ShouldAbilityRespondToEvent");
...
{
	static auto Func = Class->GetFunction("GA_Athena_Donut_Lifesteal_C", "K2_ActivateAbilityFromEvent");
...
{
	static auto Func = Class->GetFunction("GA_Athena_Donut_Lifesteal_C", "ExecuteUbergraph_GA_Athena_Donut_Lifesteal");
