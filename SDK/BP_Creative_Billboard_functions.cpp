...
{
	static auto Func = Class->GetFunction("BP_Creative_Billboard_C", "BndEvt__FortMinigameLogic_K2Node_ComponentBoundEvent_5_OnMinigameAssignmentChanged__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("BP_Creative_Billboard_C", "Play Mode Changed");
...
{
	static auto Func = Class->GetFunction("BP_Creative_Billboard_C", "Update Static Mesh Component Visibility Options");

	Params::ABP_Creative_Billboard_C_Update_Static_Mesh_Component_Visibility_Options_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Creative_Billboard_C", "BndEvt__VisibleInGameComponent_K2Node_ComponentBoundEvent_6_On Visibility Changed__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("BP_Creative_Billboard_C", "OnWorldReady");

	Params::ABP_Creative_Billboard_C_OnWorldReady_Params Parms;
