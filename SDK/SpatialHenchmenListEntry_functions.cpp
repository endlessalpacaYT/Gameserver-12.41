...
{
	static auto Func = Class->GetFunction("SpatialHenchmenListEntry_C", "BP_OnEntryReleased");

	Params::USpatialHenchmenListEntry_C_BP_OnEntryReleased_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenListEntry_C", "BP_OnItemExpansionChanged");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenListEntry_C", "BP_OnItemSelectionChanged");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenListEntry_C", "OnListItemObjectSet");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenListEntry_C", "SetListItemDetails");
...
{
	static auto Func = Class->GetFunction("SpatialHenchmenListEntry_C", "ExecuteUbergraph_SpatialHenchmenListEntry");
