...
{
	static auto Func = Class->GetFunction("AthenaLockerTab_C", "CreatePopulationAnimArray");
...
{
	static auto Func = Class->GetFunction("AthenaLockerTab_C", "PopulationAnim");
...
{
	static auto Func = Class->GetFunction("AthenaLockerTab_C", "SetHeaderToLoadouts");
...
{
	static auto Func = Class->GetFunction("AthenaLockerTab_C", "ShowBannerLockerSlot");
...
{
	static auto Func = Class->GetFunction("AthenaLockerTab_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("AthenaLockerTab_C", "OnRefreshForNewLoadout");
...
{
	static auto Func = Class->GetFunction("AthenaLockerTab_C", "OnScratchPadSaveStateUpdated");
...
{
	static auto Func = Class->GetFunction("AthenaLockerTab_C", "OnBeginPickingLoadouts");

	Params::UAthenaLockerTab_C_OnBeginPickingLoadouts_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaLockerTab_C", "BndEvt__Button_Loadouts_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
