...
{
	static auto Func = Class->GetFunction("AthenaDirectAcquisitionMTXDetails_C", "BndEvt__CloseButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
