...
public:
	...
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_6;                        // 0x478(0x108)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_5;                        // 0x580(0x108)()
	uint8                                        Pad_5A99[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt_6;                            // 0x690(0x1B0)()
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt_5;                            // 0x840(0x1B0)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_4;                        // 0x9F0(0x108)()
	uint8                                        Pad_5A9A[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAnimNode_RigidBody                   AnimGraphNode_RigidBody_5;                         // 0xB00(0x5A0)()
	struct FAnimNode_RigidBody                   AnimGraphNode_RigidBody_4;                         // 0x10A0(0x5A0)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_3;                        // 0x1640(0x108)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_2;                        // 0x1748(0x108)()
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_2;             // 0x1850(0x20)()
	struct FAnimNode_BlendListByInt              AnimGraphNode_BlendListByInt;                      // 0x1870(0xA0)()
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_2;             // 0x1910(0x20)()
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt_4;                            // 0x1930(0x1B0)()
	...
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_8;                      // 0x1D60(0x440)()
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_1;             // 0x21A0(0x20)()
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_1;             // 0x21C0(0x20)()
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_7;                      // 0x21E0(0x440)()
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_6;                      // 0x2620(0x440)()
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_5;                      // 0x2A60(0x440)()
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_4;                      // 0x2EA0(0x440)()
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_3;                      // 0x32E0(0x440)()
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_2;                      // 0x3720(0x440)()
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_1;                      // 0x3B60(0x440)()
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics;                        // 0x3FA0(0x440)()
	struct FAnimNode_CopyPoseFromMesh            AnimGraphNode_CopyPoseFromMesh_2;                  // 0x43E0(0x140)(ContainsInstancedReference)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;               // 0x4520(0x20)()
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;               // 0x4540(0x20)()
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt_3;                            // 0x4560(0x1B0)()
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt_2;                            // 0x4710(0x1B0)()
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt_1;                            // 0x48C0(0x1B0)()
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt;                              // 0x4A70(0x1B0)()
	struct FAnimNode_BlendListByBool             AnimGraphNode_BlendListByBool;                     // 0x4C20(0xA0)()
	struct FAnimNode_CopyPoseFromMesh            AnimGraphNode_CopyPoseFromMesh_1;                  // 0x4CC0(0x140)(ContainsInstancedReference)
	struct FAnimNode_RigidBody                   AnimGraphNode_RigidBody_3;                         // 0x4E00(0x5A0)()
	struct FAnimNode_RigidBody                   AnimGraphNode_RigidBody_2;                         // 0x53A0(0x5A0)()
	struct FAnimNode_RigidBody                   AnimGraphNode_RigidBody_1;                         // 0x5940(0x5A0)()
	struct FAnimNode_RigidBody                   AnimGraphNode_RigidBody;                           // 0x5EE0(0x5A0)()
	struct FAnimNode_Constraint                  AnimGraphNode_Constraint;                          // 0x6480(0x108)()
	struct FAnimNode_CopyPoseFromMesh            AnimGraphNode_CopyPoseFromMesh;                    // 0x6588(0x140)(ContainsInstancedReference)
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_1;                        // 0x66C8(0x108)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone;                          // 0x67D0(0x108)()
	struct FAnimNode_Root                        AnimGraphNode_Root;                                // 0x68D8(0x30)()
	...
	{
		static class UClass* Clss = UObject::FindClassFast("F_MED_Desert_Ops_Camo_Hair_AnimBP_C");
		return Clss;
	}
