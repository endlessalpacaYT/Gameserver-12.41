...
struct UItemInfoPresentationWidget_C_HandleOutro_Params
{
public:
...
struct UItemInfoPresentationWidget_C_HandleInitialState_Params
{
public:
...
struct UItemInfoPresentationWidget_C_HandleIntro_Params
{
public:
	class UUMGSequencePlayer*                    CallFunc_PlayAnimationForward_ReturnValue;         // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
