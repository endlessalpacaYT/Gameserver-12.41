...
{
	static auto Func = Class->GetFunction("ToastWidgetDonut_C", "ShowText");
...
{
	static auto Func = Class->GetFunction("ToastWidgetDonut_C", "SetToast");
...
{
	static auto Func = Class->GetFunction("ToastWidgetDonut_C", "BndEvt__OpenButton_K2Node_ComponentBoundEvent_5_CommonButtonClicked__DelegateSignature");
