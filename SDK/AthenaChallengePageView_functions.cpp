...
{
	static auto Func = Class->GetFunction("AthenaChallengePageView_C", "BP_OnNumPagesSet");
...
{
	static auto Func = Class->GetFunction("AthenaChallengePageView_C", "BP_OnCyclePageIn");
...
{
	static auto Func = Class->GetFunction("AthenaChallengePageView_C", "BP_OnCyclePageOut");
...
{
	static auto Func = Class->GetFunction("AthenaChallengePageView_C", "BP_OnIsInGameSet");
...
{
	static auto Func = Class->GetFunction("AthenaChallengePageView_C", "OnAnimFinished");

	Params::UAthenaChallengePageView_C_OnAnimFinished_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaChallengePageView_C", "ExecuteUbergraph_AthenaChallengePageView");
