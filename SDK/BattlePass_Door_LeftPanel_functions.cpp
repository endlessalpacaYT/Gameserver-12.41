...
{
	static auto Func = Class->GetFunction("BattlePass_Door_LeftPanel_C", "SetDoorPanelStyle");
...
{
	static auto Func = Class->GetFunction("BattlePass_Door_LeftPanel_C", "SetStyleUnpurchased");
...
{
	static auto Func = Class->GetFunction("BattlePass_Door_LeftPanel_C", "InitLevel");
...
{
	static auto Func = Class->GetFunction("BattlePass_Door_LeftPanel_C", "ExecuteUbergraph_BattlePass_Door_LeftPanel");
