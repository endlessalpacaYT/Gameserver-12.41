...
{
	static auto Func = Class->GetFunction("BP_CaptureItem_C", "Play Reaction Effects__FinishedFunc");

	Params::ABP_CaptureItem_C_Play_Reaction_Effects__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_CaptureItem_C", "Play Reaction Effects__UpdateFunc");

	Params::ABP_CaptureItem_C_Play_Reaction_Effects__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_CaptureItem_C", "Play Reaction Effects__Weapon Fire__EventFunc");

	Params::ABP_CaptureItem_C_Play_Reaction_Effects__Weapon_Fire__EventFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_CaptureItem_C", "Start Reaction Effects");

	Params::ABP_CaptureItem_C_Start_Reaction_Effects_Params Parms;
