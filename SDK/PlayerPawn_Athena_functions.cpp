...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "Get Creative Effect Data");
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "DiscardContrailComponents");
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "DeactivateContrailComponents");
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "OnLoaded_C39B713B4FA84EFFEF72F59B01709EA6");
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "Cleanup Contrails");

	Params::APlayerPawn_Athena_C_Cleanup_Contrails_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "OnBeginParachuteMovement");

	Params::APlayerPawn_Athena_C_OnBeginParachuteMovement_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "OnEndParachuteMovement");

	Params::APlayerPawn_Athena_C_OnEndParachuteMovement_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "BeginAsyncLoadingContrails");

	Params::APlayerPawn_Athena_C_BeginAsyncLoadingContrails_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "Setup Contrails");

	Params::APlayerPawn_Athena_C_Setup_Contrails_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "Activate Fully Loaded Contrails");

	Params::APlayerPawn_Athena_C_Activate_Fully_Loaded_Contrails_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "AllowContrailLoadingAgain");

	Params::APlayerPawn_Athena_C_AllowContrailLoadingAgain_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "FinishAsyncLoadingContrails");

	Params::APlayerPawn_Athena_C_FinishAsyncLoadingContrails_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "OnWeaponEquipped");
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "ToggleRes");
