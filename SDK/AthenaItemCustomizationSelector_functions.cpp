...
{
	static auto Func = Class->GetFunction("AthenaItemCustomizationSelector_C", "HandleTextChanged");
...
{
	static auto Func = Class->GetFunction("AthenaItemCustomizationSelector_C", "BndEvt__CloseButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
