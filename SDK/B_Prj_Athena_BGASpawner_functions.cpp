...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_BGASpawner_C", "GetClosestPoint");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_BGASpawner_C", "SpawnBGA_");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_BGASpawner_C", "WillBounceOffTarget");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_BGASpawner_C", "ReceiveHit");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_BGASpawner_C", "BndEvt__WaterInteractionComponent_K2Node_ComponentBoundEvent_1_WaterInteractionOnEnterWater__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_BGASpawner_C", "Held Water Impact");

	Params::AB_Prj_Athena_BGASpawner_C_Held_Water_Impact_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_BGASpawner_C", "ExecuteUbergraph_B_Prj_Athena_BGASpawner");
