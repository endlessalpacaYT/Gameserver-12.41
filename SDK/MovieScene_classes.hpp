...
public:
	...
	uint8                                        Pad_B37[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B38[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B7C[0x15];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B8A[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C25[0x3E0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C28[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C2A[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
