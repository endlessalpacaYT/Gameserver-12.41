...
{
	static auto Func = Class->GetFunction("SpatialCustomizationSelection_C", "HandleCategoryUpdated");
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationSelection_C", "OnCategoryUpdated");
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationSelection_C", "OnUpdateFinalizedText");
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationSelection_C", "BP_OnActivated");

	Params::USpatialCustomizationSelection_C_BP_OnActivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationSelection_C", "Construct");

	Params::USpatialCustomizationSelection_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationSelection_C", "Play Intro Animation ");

	Params::USpatialCustomizationSelection_C_Play_Intro_Animation__Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationSelection_C", "OnFinalizeChoiceFinished");
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationSelection_C", "BndEvt__Button_NextChoice_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationSelection_C", "BndEvt__Button_PreviousChoice_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationSelection_C", "ExecuteUbergraph_SpatialCustomizationSelection");
