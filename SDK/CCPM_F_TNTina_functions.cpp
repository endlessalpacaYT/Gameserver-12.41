...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "ApplyLevelParam");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "ApplyOverrideToItems");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "GetAssociatedAthenaController");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "Death Check");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "OnStatChanged_4420F05948922168EF6CC4BEA7C62A4B");
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "OnPawnAndPartChanged");

	Params::ACCPM_F_TNTina_C_OnPawnAndPartChanged_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "OnActualStatChange");

	Params::ACCPM_F_TNTina_C_OnActualStatChange_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "HackyWorkaroundRefreshTimerGuy");

	Params::ACCPM_F_TNTina_C_HackyWorkaroundRefreshTimerGuy_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "ResetSafetyGate");

	Params::ACCPM_F_TNTina_C_ResetSafetyGate_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "OnPostResIn");

	Params::ACCPM_F_TNTina_C_OnPostResIn_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "InitializeVariabels");

	Params::ACCPM_F_TNTina_C_InitializeVariabels_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_F_TNTina_C", "ExecuteUbergraph_CCPM_F_TNTina");
