...
{
	static auto Func = Class->GetFunction("MinigameSettingsMachine_C", "UpdateGameStartCountdown");
...
{
	static auto Func = Class->GetFunction("MinigameSettingsMachine_C", "AdditionalUIExtensionValidityChecks");
