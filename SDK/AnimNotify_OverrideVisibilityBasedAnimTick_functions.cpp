...
{
	static auto Func = Class->GetFunction("AnimNotify_OverrideVisibilityBasedAnimTick_C", "Received_NotifyEnd");
...
{
	static auto Func = Class->GetFunction("AnimNotify_OverrideVisibilityBasedAnimTick_C", "Received_NotifyBegin");
