...
{
	static auto Func = Class->GetFunction("Feedback_C", "Update Send Button Enabled");
...
{
	static auto Func = Class->GetFunction("Feedback_C", "BndEvt__CloseButton_K2Node_ComponentBoundEvent_7_CommonButtonClicked__DelegateSignature");
