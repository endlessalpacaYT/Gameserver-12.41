...
{
	static auto Func = Class->GetFunction("GCNS_GM_OnPreviewEmoji_C", "HandleAudioSystem");
...
{
	static auto Func = Class->GetFunction("GCNS_GM_OnPreviewEmoji_C", "OnBurst");
...
{
	static auto Func = Class->GetFunction("GCNS_GM_OnPreviewEmoji_C", "HandleParticleSystem");
