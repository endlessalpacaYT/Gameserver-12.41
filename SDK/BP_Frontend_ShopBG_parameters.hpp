...
struct ABP_Frontend_ShopBG_C_DonutPushUI__FinishedFunc_Params
{
public:
};
...
struct ABP_Frontend_ShopBG_C_DonutPushUI__UpdateFunc_Params
{
public:
};
...
struct ABP_Frontend_ShopBG_C_DonutPushUI__Background__EventFunc_Params
{
public:
};
...
struct ABP_Frontend_ShopBG_C_BackGroundKick__FinishedFunc_Params
{
public:
};
...
struct ABP_Frontend_ShopBG_C_BackGroundKick__UpdateFunc_Params
{
public:
};
...
struct ABP_Frontend_ShopBG_C_PlayDonutSequenceAnimation_Params
{
public:
};
...
struct ABP_Frontend_ShopBG_C_DonutSequenceHeartbeatOver_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_67C7[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_67C8[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
