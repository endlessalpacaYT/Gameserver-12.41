...
{
	static auto Func = Class->GetFunction("FortVolumeActor_PrefabGrenades_C", "OnDeathPlayEffects_2");

	Params::AFortVolumeActor_PrefabGrenades_C_OnDeathPlayEffects_2_Params Parms;
