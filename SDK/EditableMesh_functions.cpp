...
{
	static auto Func = Class->GetFunction("EditableMesh", "SplitPolygonalMesh");
...
{
	static auto Func = Class->GetFunction("EditableMesh", "SearchSpatialDatabaseForPolygonsPotentiallyIntersectingPlane");
...
{
	static auto Func = Class->GetFunction("EditableMesh", "SearchSpatialDatabaseForPolygonsInVolume");
