...
{
	static auto Func = Class->GetFunction("B_ShootingTarget_Master_C", "OnRep_TargetMeshSetting");

	Params::AB_ShootingTarget_Master_C_OnRep_TargetMeshSetting_Params Parms;
