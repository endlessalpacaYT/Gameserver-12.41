...
{
	static auto Func = Class->GetFunction("BP_LocalPlayerBannerEditor_C", "BndEvt__Button_CloseEditorButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
