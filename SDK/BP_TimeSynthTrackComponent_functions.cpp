...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "GetBPM");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "OnQuantizationBar");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "SetPlaystate");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "CheckPlaystate");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "OnQuantizationBeat");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "HasTransitionForTrack");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "LoopCurrentTrack");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "CalculateTrackLengthBeats");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "QueueTrackStop");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "QueueTrackStart");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "SetController");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthTrackComponent_C", "OnPlayStateChanged__DelegateSignature");
