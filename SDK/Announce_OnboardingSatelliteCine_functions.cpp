...
{
	static auto Func = Class->GetFunction("Announce_OnboardingSatelliteCine_C", "ChinaBuildSkipPrerendered");

	Params::AAnnounce_OnboardingSatelliteCine_C_ChinaBuildSkipPrerendered_Params Parms;
