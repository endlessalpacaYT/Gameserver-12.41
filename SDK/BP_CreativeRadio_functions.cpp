...
{
	static auto Func = Class->GetFunction("BP_CreativeRadio_C", "BndEvt__ToyOptionsComponent_K2Node_ComponentBoundEvent_1_AnyPropertyChangedDelegate__DelegateSignature");

	Params::ABP_CreativeRadio_C_BndEvt__ToyOptionsComponent_K2Node_ComponentBoundEvent_1_AnyPropertyChangedDelegate__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_CreativeRadio_C", "OnWorldReady");

	Params::ABP_CreativeRadio_C_OnWorldReady_Params Parms;
