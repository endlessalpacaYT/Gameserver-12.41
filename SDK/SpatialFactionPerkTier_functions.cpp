...
{
	static auto Func = Class->GetFunction("SpatialFactionPerkTier_C", "OnInitializePerkTier");
...
{
	static auto Func = Class->GetFunction("SpatialFactionPerkTier_C", "OnFactionSet");
...
{
	static auto Func = Class->GetFunction("SpatialFactionPerkTier_C", "ExecuteUbergraph_SpatialFactionPerkTier");
