...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_C4_C", "BlueprintGetInteractionString");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_C4_C", "BlueprintCanInteract");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_C4_C", "GetTargetingSourceTransform");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_C4_C", "BlueprintOnInteract");
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_C4_C", "MinePlacedForceCall");

	Params::AB_BGA_Athena_C4_C_MinePlacedForceCall_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_BGA_Athena_C4_C", "BndEvt__FortWaterInteraction_K2Node_ComponentBoundEvent_0_WaterInteractionOnEnterWater__DelegateSignature");
