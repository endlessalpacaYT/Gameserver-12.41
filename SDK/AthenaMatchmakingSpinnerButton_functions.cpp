...
{
	static auto Func = Class->GetFunction("AthenaMatchmakingSpinnerButton_C", "Highlight");
...
{
	static auto Func = Class->GetFunction("AthenaMatchmakingSpinnerButton_C", "SetArrowVisibility");
...
{
	static auto Func = Class->GetFunction("AthenaMatchmakingSpinnerButton_C", "OnFocusLost");
