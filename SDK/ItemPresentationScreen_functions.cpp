...
{
	static auto Func = Class->GetFunction("ItemPresentationScreen_C", "HandleFadeAnimFinished");
...
{
	static auto Func = Class->GetFunction("ItemPresentationScreen_C", "HandlePaidItemIntro");
...
{
	static auto Func = Class->GetFunction("ItemPresentationScreen_C", "StartFade");
...
{
	static auto Func = Class->GetFunction("ItemPresentationScreen_C", "PlayIntro");
...
{
	static auto Func = Class->GetFunction("ItemPresentationScreen_C", "HandleAnimationInitialState");
