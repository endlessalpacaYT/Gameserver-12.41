...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "SequenceEvent__ENTRYPOINTDonutChallengeScreen_0");

	Params::UDonutChallengeScreen_C_SequenceEvent__ENTRYPOINTDonutChallengeScreen_0_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "OnMouseButtonUp_0");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "On_Border_WindowMinimize_1_MouseButtonDown_0");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "SetBattlepassState");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "On_Border_BattlepassUpsellMinimized_MouseButtonDown_0");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "On_Border_WindowMinimize_MouseButtonDown_0");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "On_Border_Minimized_MouseButtonDown_0");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "SetPasswordText");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "BndEvt__Button_BattlepassUpsell_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "Construct");

	Params::UDonutChallengeScreen_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "BP_OnActivated");

	Params::UDonutChallengeScreen_C_BP_OnActivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "PlayLoginSequence");

	Params::UDonutChallengeScreen_C_PlayLoginSequence_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "ToggleChallengesWindow");

	Params::UDonutChallengeScreen_C_ToggleChallengesWindow_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "BndEvt__Button_Back_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "SequenceEvent_0");

	Params::UDonutChallengeScreen_C_SequenceEvent_0_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "ResetDonutPC");

	Params::UDonutChallengeScreen_C_ResetDonutPC_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "BndEvt__IconTextButton_155_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "ToggleBattlePassWindow");

	Params::UDonutChallengeScreen_C_ToggleBattlePassWindow_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "BndEvt__IconTextButton_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "BndEvt__IconTextButton_1_K2Node_ComponentBoundEvent_2_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "UpdateBPOwnedStateVisuals");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "Anim_SetupControllerFocus");

	Params::UDonutChallengeScreen_C_Anim_SetupControllerFocus_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "BP_OnDeactivated");

	Params::UDonutChallengeScreen_C_BP_OnDeactivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "ShowSkinUnlockMessage");
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "PlayDonutAttract");

	Params::UDonutChallengeScreen_C_PlayDonutAttract_Params Parms;
...
{
	static auto Func = Class->GetFunction("DonutChallengeScreen_C", "ExecuteUbergraph_DonutChallengeScreen");
