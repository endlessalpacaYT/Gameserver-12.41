...
public:
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x138(0x28)()
	...
	struct FGameplayEventData                    K2Node_CustomEvent_Payload;                        // 0x178(0xB0)()
