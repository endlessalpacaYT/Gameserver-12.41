...
struct UGA_Athena_Track_DangerGrape_C_OnRep_SnowmenActors_Params
{
public:
};
...
struct UGA_Athena_Track_DangerGrape_C_K2_ActivateAbility_Params
{
public:
};
...
public:
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x210(0x28)()
	...
	struct FGameplayEventData                    Temp_struct_Variable_1;                            // 0x278(0xB0)()
	...
	struct FGameplayEventData                    K2Node_CustomEvent_Payload_1;                      // 0x360(0xB0)()
