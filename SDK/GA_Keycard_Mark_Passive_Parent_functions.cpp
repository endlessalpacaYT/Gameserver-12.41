...
{
	static auto Func = Class->GetFunction("GA_Keycard_Mark_Passive_Parent_C", "InitAbility");
...
{
	static auto Func = Class->GetFunction("GA_Keycard_Mark_Passive_Parent_C", "K2_ActivateAbility");

	Params::UGA_Keycard_Mark_Passive_Parent_C_K2_ActivateAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_Keycard_Mark_Passive_Parent_C", "DrawTrailToVault");

	Params::UGA_Keycard_Mark_Passive_Parent_C_DrawTrailToVault_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_Keycard_Mark_Passive_Parent_C", "ExecuteUbergraph_GA_Keycard_Mark_Passive_Parent");
