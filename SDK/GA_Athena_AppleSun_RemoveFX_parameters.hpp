...
struct UGA_Athena_AppleSun_RemoveFX_C_K2_ActivateAbility_Params
{
public:
};
...
struct UGA_Athena_AppleSun_RemoveFX_C_VehicleLandedCheck_Params
{
public:
};
...
struct UGA_Athena_AppleSun_RemoveFX_C_Remove_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_5EDA[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5EDE[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
