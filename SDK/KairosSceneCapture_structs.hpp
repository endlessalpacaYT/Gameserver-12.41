...
public:
	...
	uint8                                        Pad_E25[0xD8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E28[0xE];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E2A[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E34[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E44[0xE];                                      // Fixing Size After Last Property  [ Dumper-7 ]
