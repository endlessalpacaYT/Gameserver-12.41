...
struct UFortnite_Base_Head_Export_Skeleton_AnimBP_C_BlueprintUpdateAnimation_Params
{
public:
...
public:
	...
	bool                                         CallFunc_GetPlaylistUsesCustomCharacterParts_ReturnValue; // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
