...
{
	static auto Func = Class->GetFunction("FortHoagieVehicle", "OnStartCriticalHealth");

	Params::AFortHoagieVehicle_OnStartCriticalHealth_Params Parms;
...
{
	static auto Func = Class->GetFunction("FortHoagieVehicle", "OnExplode");

	Params::AFortHoagieVehicle_OnExplode_Params Parms;
...
{
	static auto Func = Class->GetFunction("FortHoagieVehicle", "GetIsCriticalHealth");
