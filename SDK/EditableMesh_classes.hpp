...
public:
	...
	uint8                                        Pad_1E73[0x9C];                                    // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("EditableGeometryCollectionAdapter");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_2068[0x390];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UEditableMeshAdapter*>          Adapters;                                          // 0x3B8(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_2069[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_206A[0x148];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_206B[0x1E4];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_208E[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
