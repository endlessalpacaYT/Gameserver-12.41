...
public:
	...
	class UWidgetAnimation*                      OnSelectAnim_FromHover;                            // 0x308(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	class UWidgetAnimation*                      Flare_Loop;                                        // 0x318(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("AthenaMapNavigableIconStackOfChallenges_C");
		return Clss;
	}
