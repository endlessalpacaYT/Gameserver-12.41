...
{
	static auto Func = Class->GetFunction("StoreMain_RMT_OfferDetails_C", "ShowPurchaseConfirmation");

	Params::UStoreMain_RMT_OfferDetails_C_ShowPurchaseConfirmation_Params Parms;
...
{
	static auto Func = Class->GetFunction("StoreMain_RMT_OfferDetails_C", "BP_OnActivated");

	Params::UStoreMain_RMT_OfferDetails_C_BP_OnActivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("StoreMain_RMT_OfferDetails_C", "ShowPurchasedOverlay");
...
{
	static auto Func = Class->GetFunction("StoreMain_RMT_OfferDetails_C", "BndEvt__Button_Undo_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("StoreMain_RMT_OfferDetails_C", "ShowUndoInBottomBar");

	Params::UStoreMain_RMT_OfferDetails_C_ShowUndoInBottomBar_Params Parms;
...
{
	static auto Func = Class->GetFunction("StoreMain_RMT_OfferDetails_C", "HideUndoInBottomBar");

	Params::UStoreMain_RMT_OfferDetails_C_HideUndoInBottomBar_Params Parms;
