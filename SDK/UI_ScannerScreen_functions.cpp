...
{
	static auto Func = Class->GetFunction("UI_ScannerScreen_C", "EventFail");
...
{
	static auto Func = Class->GetFunction("UI_ScannerScreen_C", "EventSuccess");
...
{
	static auto Func = Class->GetFunction("UI_ScannerScreen_C", "EventScanning");

	Params::UUI_ScannerScreen_C_EventScanning_Params Parms;
...
{
	static auto Func = Class->GetFunction("UI_ScannerScreen_C", "EventTargetLost");
...
{
	static auto Func = Class->GetFunction("UI_ScannerScreen_C", "ExecuteUbergraph_UI_ScannerScreen");
