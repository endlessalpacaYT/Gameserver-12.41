...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "GetIsPlaying");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "GetTracksForRegistration");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "CalculateMaxClipDuration");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "QueueTrackStartInternal");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "OnQuantizationBar");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "FlushExtraClips");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "OnQuantizationBeat");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "PlayTransition");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "StopAllMusic");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "ChangeTrack");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "OnReady_CB064A4141A4B166152154812676A378");

	Params::ABP_TimeSynthController_Base_C_OnReady_CB064A4141A4B166152154812676A378_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "BndEvt__BP_TimeSynthTrackComponent_Infiltration_K2Node_ComponentBoundEvent_0_OnPlayStateChanged__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "SetVolumeGroup");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "BndEvt__BP_TimeSynthTrackComponent_Suspicious_K2Node_ComponentBoundEvent_1_OnPlayStateChanged__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "BndEvt__BP_TimeSynthTrackComponent_Alerted_K2Node_ComponentBoundEvent_2_OnPlayStateChanged__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "ReceiveBeginPlay");

	Params::ABP_TimeSynthController_Base_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "ReceiveEndPlay");
...
{
	static auto Func = Class->GetFunction("BP_TimeSynthController_Base_C", "ExecuteUbergraph_BP_TimeSynthController_Base");
