...
public:
	...
	uint8                                        Pad_6CD9[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetAccountLevelText_ReturnValue;          // 0x160(0x18)()
	...
	class FText                                  CallFunc_GetFriendMatchXpBoostText_Result;         // 0x180(0x18)()
	...
	class FText                                  CallFunc_GetCurrentSeasonNumberAsText_ReturnValue; // 0x1A0(0x18)()
