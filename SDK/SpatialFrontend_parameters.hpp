...
struct USpatialFrontend_C_BP_OnActivated_Params
{
public:
};
...
struct USpatialFrontend_C_BP_OnDeactivated_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_6E1D[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FFortEventLevelNavigationDisplayDetails CallFunc_GetDisplayDetails_ReturnValue;            // 0x28(0x10)()
