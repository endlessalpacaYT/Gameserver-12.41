...
{
	static auto Func = Class->GetFunction("B_HeldObjectSocket_C", "ValidateHeldObject");
...
{
	static auto Func = Class->GetFunction("B_HeldObjectSocket_C", "OnRep_SocketIsFilled");
...
{
	static auto Func = Class->GetFunction("B_HeldObjectSocket_C", "ReceiveBeginPlay");

	Params::AB_HeldObjectSocket_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_HeldObjectSocket_C", "OnHitHeldObject");
...
{
	static auto Func = Class->GetFunction("B_HeldObjectSocket_C", "EventOnSocketFilled");

	Params::AB_HeldObjectSocket_C_EventOnSocketFilled_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_HeldObjectSocket_C", "EventOnSocketEmptied");

	Params::AB_HeldObjectSocket_C_EventOnSocketEmptied_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_HeldObjectSocket_C", "ExecuteUbergraph_B_HeldObjectSocket");
