...
{
	static auto Func = Class->GetFunction("B_Prj_Arrow_ExplodeOnImpact_Athena_Parent_C", "OnRep_HitLocation");
...
{
	static auto Func = Class->GetFunction("B_Prj_Arrow_ExplodeOnImpact_Athena_Parent_C", "UserConstructionScript");

	Params::AB_Prj_Arrow_ExplodeOnImpact_Athena_Parent_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Arrow_ExplodeOnImpact_Athena_Parent_C", "Event_Building_Actor_Destroyed");

	Params::AB_Prj_Arrow_ExplodeOnImpact_Athena_Parent_C_Event_Building_Actor_Destroyed_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Arrow_ExplodeOnImpact_Athena_Parent_C", "ReceiveBeginPlay");

	Params::AB_Prj_Arrow_ExplodeOnImpact_Athena_Parent_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Arrow_ExplodeOnImpact_Athena_Parent_C", "OnTouched");
...
{
	static auto Func = Class->GetFunction("B_Prj_Arrow_ExplodeOnImpact_Athena_Parent_C", "BndEvt__WaterInteractionComponent_K2Node_ComponentBoundEvent_0_WaterInteractionOnEnterWater__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("B_Prj_Arrow_ExplodeOnImpact_Athena_Parent_C", "ExecuteUbergraph_B_Prj_Arrow_ExplodeOnImpact_Athena_Parent");
