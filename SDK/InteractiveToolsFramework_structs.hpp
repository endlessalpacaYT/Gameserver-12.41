...
public:
	...
	uint8                                        Pad_2CBE[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2CC0[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2CC1[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
