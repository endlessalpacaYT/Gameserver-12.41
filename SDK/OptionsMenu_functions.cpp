...
{
	static auto Func = Class->GetFunction("OptionsMenu_C", "ResetGameOptionsToDefault");
...
{
	static auto Func = Class->GetFunction("OptionsMenu_C", "BP_ApplySettings");
...
{
	static auto Func = Class->GetFunction("OptionsMenu_C", "DialogResult_2757852D46593FD0C2380D8F102C53DD");
...
{
	static auto Func = Class->GetFunction("OptionsMenu_C", "BndEvt__CloseButton_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature");
