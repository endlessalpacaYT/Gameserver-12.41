...
{
	static auto Func = Class->GetFunction("AthenaCustomizationSlotButton_C", "OnImageSizeChanged");
...
{
	static auto Func = Class->GetFunction("AthenaCustomizationSlotButton_C", "Save State Updated");
...
{
	static auto Func = Class->GetFunction("AthenaCustomizationSlotButton_C", "set_emptyImage");
