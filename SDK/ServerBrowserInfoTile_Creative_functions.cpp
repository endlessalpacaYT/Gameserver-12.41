...
{
	static auto Func = Class->GetFunction("ServerBrowserInfoTile_Creative_C", "OnLoaded_296230CE4FECC5810C4B9AB00A3162F7");
...
{
	static auto Func = Class->GetFunction("ServerBrowserInfoTile_Creative_C", "SetBackgroundImage");
