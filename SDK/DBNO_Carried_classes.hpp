...
public:
	...
	struct FAnimNode_Root                        AnimGraphNode_Root;                                // 0x1D78(0x30)()
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;               // 0x1DA8(0x20)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_1;                        // 0x1DC8(0x108)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone;                          // 0x1ED0(0x108)()
	struct FAnimNode_SequencePlayer              AnimGraphNode_SequencePlayer_1;                    // 0x1FD8(0x78)()
	struct FAnimNode_ApplyAdditive               AnimGraphNode_ApplyAdditive;                       // 0x2050(0xC8)()
	uint8                                        Pad_4EBF[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAnimNode_TwoBoneIK                   AnimGraphNode_TwoBoneIK;                           // 0x2120(0x1E0)()
	...
	struct FAnimNode_LinkedAnimGraph             AnimGraphNode_SubInstance;                         // 0x2308(0x98)()
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;               // 0x23A0(0x20)()
	struct FAnimNode_TransitionResult            AnimGraphNode_TransitionResult_1;                  // 0x23C0(0x28)()
	struct FAnimNode_TransitionResult            AnimGraphNode_TransitionResult;                    // 0x23E8(0x28)()
	struct FAnimNode_SequenceEvaluator           AnimGraphNode_SequenceEvaluator_1;                 // 0x2410(0x48)()
	struct FAnimNode_StateResult                 AnimGraphNode_StateResult_2;                       // 0x2458(0x30)()
	struct FAnimNode_SequencePlayer              AnimGraphNode_SequencePlayer;                      // 0x2488(0x78)()
	struct FAnimNode_StateResult                 AnimGraphNode_StateResult_1;                       // 0x2500(0x30)()
	struct FAnimNode_SequenceEvaluator           AnimGraphNode_SequenceEvaluator;                   // 0x2530(0x48)()
	struct FAnimNode_StateResult                 AnimGraphNode_StateResult;                         // 0x2578(0x30)()
	struct FAnimNode_StateMachine                AnimGraphNode_StateMachine;                        // 0x25A8(0xB0)()
	struct FAnimNode_TwoWayBlend                 AnimGraphNode_TwoWayBlend;                         // 0x2658(0xC8)()
	struct FAnimNode_SaveCachedPose              AnimGraphNode_SaveCachedPose;                      // 0x2720(0xB8)()
	struct FAnimNode_UseCachedPose               AnimGraphNode_UseCachedPose_1;                     // 0x27D8(0x28)()
	struct FAnimNode_UseCachedPose               AnimGraphNode_UseCachedPose;                       // 0x2800(0x28)()
