...
{
	static auto Func = Class->GetFunction("GCNS_GM_OnDisplayEmoji_C", "HandleAudioSystem");
...
{
	static auto Func = Class->GetFunction("GCNS_GM_OnDisplayEmoji_C", "HandleParticleSystem");
...
{
	static auto Func = Class->GetFunction("GCNS_GM_OnDisplayEmoji_C", "OnBurst");
