...
{
	static auto Func = Class->GetFunction("SpatialFactionPerkProgress_C", "OnInitializePerkProgress");
...
{
	static auto Func = Class->GetFunction("SpatialFactionPerkProgress_C", "OnFactionSet");
...
{
	static auto Func = Class->GetFunction("SpatialFactionPerkProgress_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("SpatialFactionPerkProgress_C", "ExecuteUbergraph_SpatialFactionPerkProgress");
