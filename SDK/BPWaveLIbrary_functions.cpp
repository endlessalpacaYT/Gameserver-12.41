...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Generate Wave Spectrum");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Harvest Wave Params");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Water Depth to Wavespeed");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Gerstner Wave_MPC_Shallow");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Gerstner 3 Waves");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Rotation from Normal");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Finalize Gerstner Normal");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Wave Rotation Setup");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Wavelength to Wavespeed");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Exp2");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Gerstner Wave_MPC_Deep");
...
{
	static auto Func = Class->GetFunction("BPWaveLIbrary_C", "Gerstner Wave");
