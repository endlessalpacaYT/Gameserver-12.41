...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "UpdateQuest");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "ShouldApplySnowman?");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "Should Bounce?");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "OnTouched");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "Explode");

	Params::AB_Prj_Athena_SneakySnowmanV2_C_Explode_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "OnExploded");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "ReceiveBeginPlay");

	Params::AB_Prj_Athena_SneakySnowmanV2_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "BndEvt__WaterInteractionComponent_K2Node_ComponentBoundEvent_0_WaterInteractionOnEnterWater__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "Apply Snowman To Self");

	Params::AB_Prj_Athena_SneakySnowmanV2_C_Apply_Snowman_To_Self_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Athena_SneakySnowmanV2_C", "ExecuteUbergraph_B_Prj_Athena_SneakySnowmanV2");
