...
{
	static auto Func = Class->GetFunction("Creative_Enabled_Component_C", "Can be Enabled");
...
{
	static auto Func = Class->GetFunction("Creative_Enabled_Component_C", "Initialize Component");
...
{
	static auto Func = Class->GetFunction("Creative_Enabled_Component_C", "Bind to Minigame");
...
{
	static auto Func = Class->GetFunction("Creative_Enabled_Component_C", "Minigame State Changed");
...
{
	static auto Func = Class->GetFunction("Creative_Enabled_Component_C", "Minigame Play Mode Changed");
...
{
	static auto Func = Class->GetFunction("Creative_Enabled_Component_C", "ExecuteUbergraph_Creative_Enabled_Component");
