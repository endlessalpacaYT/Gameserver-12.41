...
{
	static auto Func = Class->GetFunction("B_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C", "ScalePlayerThermal__FinishedFunc");

	Params::AB_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C_ScalePlayerThermal__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C", "ScalePlayerThermal__UpdateFunc");

	Params::AB_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C_ScalePlayerThermal__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C", "OnSetTargeting");
...
{
	static auto Func = Class->GetFunction("B_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C", "PlayScopePP");

	Params::AB_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C_PlayScopePP_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C", "ReverseScopePP");

	Params::AB_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C_ReverseScopePP_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C", "ForceScopeBackImmediatly");

	Params::AB_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C_ForceScopeBackImmediatly_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena_C", "ExecuteUbergraph_B_Rifle_Sniper_Suppressed_ThermalScope_SpyTech_Athena");
