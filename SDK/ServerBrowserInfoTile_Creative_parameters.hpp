...
public:
	...
	uint8                                        Pad_6697[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  Temp_text_Variable_1;                              // 0x128(0x18)()
	struct FFortCreativeServerDisplayOption      CallFunc_GetDataTableRowFromName_OutRow;           // 0x140(0x40)()
