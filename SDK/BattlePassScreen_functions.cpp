...
{
	static auto Func = Class->GetFunction("BattlePassScreen_C", "Construct");

	Params::UBattlePassScreen_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("BattlePassScreen_C", "HandleOnInputMethodChanged");
...
{
	static auto Func = Class->GetFunction("BattlePassScreen_C", "Destruct");

	Params::UBattlePassScreen_C_Destruct_Params Parms;
...
{
	static auto Func = Class->GetFunction("BattlePassScreen_C", "OnSetDifferentBPText");

	Params::UBattlePassScreen_C_OnSetDifferentBPText_Params Parms;
