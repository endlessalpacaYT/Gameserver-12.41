...
{
	static auto Func = Class->GetFunction("B_HeldObject_Parent_C", "OnRep_IsSocketed");
...
{
	static auto Func = Class->GetFunction("B_HeldObject_Parent_C", "BlueprintGetInteractionString");
...
{
	static auto Func = Class->GetFunction("B_HeldObject_Parent_C", "OnRep_IsHeld");
...
{
	static auto Func = Class->GetFunction("B_HeldObject_Parent_C", "BlueprintCanInteract");
...
{
	static auto Func = Class->GetFunction("B_HeldObject_Parent_C", "BlueprintOnInteract");
...
{
	static auto Func = Class->GetFunction("B_HeldObject_Parent_C", "ReceiveBeginPlay");

	Params::AB_HeldObject_Parent_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_HeldObject_Parent_C", "ExecuteUbergraph_B_HeldObject_Parent");
