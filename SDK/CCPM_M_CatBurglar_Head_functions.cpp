...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "Death Check");
...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "OnStatChanged_6429FF264C5FC42E64F53EB173B73660");
...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "OnPawnAndPartChanged");

	Params::ACCPM_M_CatBurglar_Head_C_OnPawnAndPartChanged_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "OnActualStatChange");

	Params::ACCPM_M_CatBurglar_Head_C_OnActualStatChange_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "HackyWorkaroundRefreshTimerGuy");

	Params::ACCPM_M_CatBurglar_Head_C_HackyWorkaroundRefreshTimerGuy_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "OnPostResIn");

	Params::ACCPM_M_CatBurglar_Head_C_OnPostResIn_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "ResetSafetyGate");

	Params::ACCPM_M_CatBurglar_Head_C_ResetSafetyGate_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "ReceiveBeginPlay");

	Params::ACCPM_M_CatBurglar_Head_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "InitializeVariabels");

	Params::ACCPM_M_CatBurglar_Head_C_InitializeVariabels_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_CatBurglar_Head_C", "ExecuteUbergraph_CCPM_M_CatBurglar_Head");
