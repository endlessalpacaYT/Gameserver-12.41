...
{
	static auto Func = Class->GetFunction("SpatialCustomizationCategoryEntry_C", "Set rim brush color");
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationCategoryEntry_C", "HandleCategoryStateSet");
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationCategoryEntry_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationCategoryEntry_C", "OnCategoryStateSet");
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationCategoryEntry_C", "BP_OnHovered");

	Params::USpatialCustomizationCategoryEntry_C_BP_OnHovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationCategoryEntry_C", "BP_OnUnhovered");

	Params::USpatialCustomizationCategoryEntry_C_BP_OnUnhovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("SpatialCustomizationCategoryEntry_C", "ExecuteUbergraph_SpatialCustomizationCategoryEntry");
