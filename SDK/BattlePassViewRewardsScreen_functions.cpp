...
{
	static auto Func = Class->GetFunction("BattlePassViewRewardsScreen_C", "BndEvt__CloseButton_K2Node_ComponentBoundEvent_2_CommonButtonClicked__DelegateSignature");
