...
public:
	...
	uint8                                        Pad_67FB[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FLinearColor                          MPC_ManualSunlightVector;                          // 0x284(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
