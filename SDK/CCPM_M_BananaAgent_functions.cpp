...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "ApplyLevelParam");
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "ApplyOverrideToItems");
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "GetAssociatedAthenaController");
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "Death Check");
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "OnStatChanged_91684B16413237DEB51BD6867C4D5996");
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "OnPawnAndPartChanged");

	Params::ACCPM_M_BananaAgent_C_OnPawnAndPartChanged_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "OnActualStatChange");

	Params::ACCPM_M_BananaAgent_C_OnActualStatChange_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "HackyWorkaroundRefreshTimerGuy");

	Params::ACCPM_M_BananaAgent_C_HackyWorkaroundRefreshTimerGuy_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "ResetSafetyGate");

	Params::ACCPM_M_BananaAgent_C_ResetSafetyGate_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "OnPostResIn");

	Params::ACCPM_M_BananaAgent_C_OnPostResIn_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "InitializeVariabels");

	Params::ACCPM_M_BananaAgent_C_InitializeVariabels_Params Parms;
...
{
	static auto Func = Class->GetFunction("CCPM_M_BananaAgent_C", "ExecuteUbergraph_CCPM_M_BananaAgent");
