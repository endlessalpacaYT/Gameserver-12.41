...
{
	static auto Func = Class->GetFunction("GA_Athena_ApplyCoolCarpet_Passive_C", "K2_ActivateAbility");

	Params::UGA_Athena_ApplyCoolCarpet_Passive_C_K2_ActivateAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_Athena_ApplyCoolCarpet_Passive_C", "K2_OnEndAbility");
...
{
	static auto Func = Class->GetFunction("GA_Athena_ApplyCoolCarpet_Passive_C", "ExecuteUbergraph_GA_Athena_ApplyCoolCarpet_Passive");
