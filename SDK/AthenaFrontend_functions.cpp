...
{
	static auto Func = Class->GetFunction("AthenaFrontend_C", "OnTrailerMediaEnded");
...
{
	static auto Func = Class->GetFunction("AthenaFrontend_C", "OnTrailerMediaOpened");
...
{
	static auto Func = Class->GetFunction("AthenaFrontend_C", "OnTrailerTransitionAudioCheck");
...
{
	static auto Func = Class->GetFunction("AthenaFrontend_C", "StartTrailerTransitionAudioCheck");
...
{
	static auto Func = Class->GetFunction("AthenaFrontend_C", "StopTrailerTransitionAudioCheck");

	Params::UAthenaFrontend_C_StopTrailerTransitionAudioCheck_Params Parms;
